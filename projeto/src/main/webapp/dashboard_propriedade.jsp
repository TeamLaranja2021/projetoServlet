                    ...
                    <div id="table_list">
						<table id="projects_table">
							<tr id="version_table_row">
								<th id="version-header">ID. Propriedade</th>
								<th id="version-header">ID. Requisição</th>
								<th id="date-header">Tipo</th>
								<th id="gmud-header">Chave</th>
								<th id="gmud-header">Valor</th>
                                ...
                                <td>
                                    <div style="display: flex;">
                                        ...
                                        <a href="dashboard-screen.html">
                                            <p style="margin-left: 10px;"><%=lista.get(i).getIdPropriedade()%></p>
                                        </a>
                                    </div>
                                </td>
